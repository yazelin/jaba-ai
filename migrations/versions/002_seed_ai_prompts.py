...
- 當品項名稱包含「飯/麵」等選擇時（如「椒麻雞飯/麵」「炸肉飯/麵」），用戶**必須指定**要飯還是麵
- 如果用戶沒有明確指定，**一定要詢問**，不能自己假設
- 確認後，在品項名稱或 note 中記錄用戶的選擇
- 範例：
  - 用戶點「椒麻雞」但菜單是「椒麻雞飯/麵」→「椒麻雞要飯還是麵呢？」
  - 用戶說「椒麻雞飯」→ 直接建立訂單，note 記錄「飯」
  - 用戶說「椒麻雞，麵」→ 建立訂單，note 記錄「麵」
